...
SECRET_KEY = 'django-insecure-!jz2xu&$j_21u(76*iq#vt$bzaiwhq70#v3^c@)^q-_3+(yxig'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['carzone-mywork.herokuapp.com','127.0.0.1:8000']
...
STATICFILES_DIRS = [
    Path.joinpath(BASE_DIR,'CarZone/static')
]
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'dvlpatel2410@gmail.com'
EMAIL_HOST_PASSWORD = 'letmechecknewfeedhere'
EMAIL_USE_TLS = True
